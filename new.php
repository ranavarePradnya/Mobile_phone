...
<?php
 session_start();
         if(isset($_SESSION['newid']));
         {
          ...
          $pid=$_SESSION['newid'];
          echo $pid;
          $accept=mysqli_query($conn,"SELECT * FROM mb_publish WHERE id='$pid'");
              ...
              if(isset($_POST['update']))
                {
                  ...
                  if($image1){
                   ...
                   echo $picture1;
                    ...
                    $update=mysqli_query($conn,"UPDATE mb_publish SET title='$title1',content='$comment1',image='$picture1',link='$weblink1',datep='$datep' WHERE id='$id'");
                    if($update)
                    {
                      echo"<script>";
                ...
                {
                  $id=$_POST['id'];
                  $delete=mysqli_query($conn,"DELETE FROM  WHERE id='$id'");
                      if($delete)
                      {
                        echo"<script>";
                        echo"document.location.replace('./index.php')";
